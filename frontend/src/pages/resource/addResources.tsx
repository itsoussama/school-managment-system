import { addResource } from "@pages/shared/utils/api";
...
import ResourceForm, { FormData } from "./components/resourceForm";

const RESOURCE_INITIAL_DATA: FormData = {
  label: "",
  qty: 0,
  category_id: 0,
};
  ...
  return (
    <div className="flex flex-col">
      ...
      <TransitionAnimation>
        <ResourceForm
          action="Create"
          initialData={RESOURCE_INITIAL_DATA}
          onFormData={(data) => addResourceQuery.mutate(data)}
